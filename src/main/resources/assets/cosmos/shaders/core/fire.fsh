...
void main() {
    ...
    vec2 node_uv = vUv;
    vec2 node_mapping_2d_1776636386216 = (node_uv + vec2(0.0, -0.5)) * vec2(2.0, 3.0);

    vec2 node_split_in = node_mapping_2d_1776636386216;
    ...
    float node_lx_1 = node_split_x + node_macro;
